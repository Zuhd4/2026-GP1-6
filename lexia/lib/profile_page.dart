...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _saveName() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        _showSuccessDialog("Your name has been updated successfully.");
      }
    } catch (e) {
      if (mounted) {
  ...
  void _showSuccessSnack(String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: const Color(0xFF59A685),
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(Icons.check_rounded,
                  color: const Color(0xFF59A685), size: 36.r),
            ),
            SizedBox(height: 16.h),
            Text(
              "Success!",
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          title: Text(
            "Change Password",
            style: GoogleFonts.montserrat(
                fontWeight: FontWeight.w600, color: textDark, fontSize: 18.sp),
          ),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              _buildDialogField("New Password", newPassController,
                  isObscure: true, error: newError),
              _buildDialogField(
                  "Confirm New Password", confirmPassController,
                  isObscure: true, error: confirmError),
            ],
          ),
          actions: [
            TextButton(
  ...
  // ── Change PIN Dialog ──
  void _showChangePinDialog(String currentPin) {
          ...
          content: Column(
            ...
            children: [
              _buildPinField(
                ...
                onChanged: (_) {
                  if (oldPinError != null)
                    setDialogState(() => oldPinError = null);
                },
              ),
              _buildPinField(
                "New PIN",
                ...
                onChanged: (_) {
                  if (newPinError != null)
                    setDialogState(() => newPinError = null);
                },
              ),
              _buildPinField(
                "Confirm New PIN",
                ...
                onChanged: (_) {
                  if (confirmPinError != null)
                    setDialogState(() => confirmPinError = null);
                },
              ),
            ],
          ),
                ...
                onPressed: isUpdating
                    ...
                    : () async {
                        ...
                        if (oldPinController.text.isEmpty) {
                          setDialogState(
                              () => oldPinError = "Current PIN required");
                          hasError = true;
                        } else if (oldPinController.text != currentPin) {
                          setDialogState(
                              () => oldPinError = "Incorrect PIN");
                          hasError = true;
                        }
                        ...
                        if (newPinController.text.isEmpty) {
                          setDialogState(
                              () => newPinError = "New PIN required");
                          hasError = true;
                        } else if (newPinController.text.length != 4) {
                          setDialogState(
                              () => newPinError = "PIN must be exactly 4 digits");
                          hasError = true;
                        } else if (!RegExp(r'^\d{4}$')
                            .hasMatch(newPinController.text)) {
                          setDialogState(
                              () => newPinError = "PIN must be numbers only");
                          hasError = true;
                        }
                        ...
                        try {
                          await FirebaseFirestore.instance
                              .collection('users')
                              .doc(currentUser!.uid)
                              .update({'pin': newPinController.text.trim()});
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          errorStyle: GoogleFonts.montserrat(
              fontSize: 9.sp, color: Colors.redAccent, height: 0.8),
          filled: true,
      ...
      body: Container(
        ...
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, userSnap) {
            ...
            // Sync name controller when not in edit mode
            if (!_isEditMode) {
              ...
              child: SafeArea(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildAccountCard(userData),
                    SizedBox(height: 20.h),
                    AnimatedOpacity(
                      opacity: _isEditMode ? 0.3 : 1.0,
                      ...
                      child: IgnorePointer(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                return Column(
                                  children: [
                                    ...children.map((doc) {
                                      ...
                                      return _childCard(
                                          data['name'], data['avatarUrl'], doc.id);
                                    }),
                                    _addChildButton(),
                                  ],
                                );
                            ...
                            _actionButton("Sign Out", Icons.logout_rounded,
                                primaryPurple, _signOut,
                                isOutlined: true),
  ...
  // ── Account card with edit mode ──
  Widget _buildAccountCard(Map<String, dynamic> userData) {
    final String currentPin = userData['pin']?.toString() ?? '0000';
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Expanded(
                child: Column(
                  children: [
                    _avatarImage(userData['avatarUrl'],
                        size: 80.r, radius: 24),
          ...
          _accountDetailTile(
            ...
            "Password",
            "••••••••",
            isAction: _isEditMode,
            onTap: _isEditMode ? _showChangePasswordDialog : null,
          ),
          ...
          _accountDetailTile(
            ...
            isAction: _isEditMode,
            onTap: _isEditMode
                ? () => _showChangePinDialog(currentPin)
                : null,
          ),
    ...
    VoidCallback? onTap,
      ...
      ListTile(
        ...
        leading: Container(
          ...
          child: Icon(icon,
              color: primaryPurple.withOpacity(0.7), size: 18.r),
        ),
        title: Text(
          title,
          style: GoogleFonts.montserrat(
          ...
          children: [
            ...
            IconButton(
              ...
              icon: Icon(Icons.delete_outline_rounded,
                  color: Colors.redAccent.withOpacity(0.6), size: 20.r),
            ),
          ],
        ),
      );
  ...
  Widget _addChildButton() => InkWell(
        onTap: () => showDialog(
            context: context, builder: (_) => const AddChildPage()),
        child: Container(
          width: double.infinity,
          ...
          child: Row(
            ...
            children: [
              Icon(Icons.add_circle_outline_rounded,
                  color: primaryPurple.withOpacity(0.6), size: 18.r),
              SizedBox(width: 8.w),
              Flexible(
                child: Text(
                  "Add Child Profile",
