...
class ChildProfilePage extends StatelessWidget {
  ...
  Widget _sectionHeader(String title, bool useOpenDyslexic) => Padding(
          ...
          body: Container(
            ...
            child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                final String pinDisplay = allowChildPin
                    ? "••••"
                    : "Not enabled";
                ...
                return SingleChildScrollView(
                  ...
                  child: SafeArea(
                    child: Column(
                      ...
                      children: [
                        _buildHeader(context, useOpenDyslexic),
                        SizedBox(height: 20.h),

                        _sectionHeader("Profile", useOpenDyslexic),
